...
-- adresse
INSERT INTO adresse (id_adresse, nom_rue, ville, code_postal) VALUES
  (1, '1 Rue de la Paix', 'Ville inconnue', '37000'),
  (2, '69 Chemin du Moulin Rouge', 'Ville inconnue', '67000'),
  (3, '138 Passage du Commerce', 'Ville inconnue', '35000'),
  (4, '87 Impasse des Tilleuls', 'Ville inconnue', '49000'),
  (5, '116 Boulevard Saint-Germain', 'Ville inconnue', '44000'),
  (6, '36 Rue de l''eglise', 'Ville inconnue', '45000'),
  (7, '141 Rue des Lilas', 'Ville inconnue', '30000'),
  (8, '15 Avenue Kleber', 'Ville inconnue', '45000'),
  (9, '31 Avenue des Champs', 'Ville inconnue', '63000'),
  (10, '41 Rue du Faubourg Saint-Antoine', 'Ville inconnue', '51100'),
  (11, '11 Rue Voltaire', 'Ville inconnue', '31000'),
  (12, '103 Rue du Commerce', 'Ville inconnue', '37000'),
  (13, '51 Allee du Bois', 'Ville inconnue', '49000'),
  (14, '150 Rue de la Mairie', 'Ville inconnue', '31000'),
  (15, '80 Boulevard du General Leclerc', 'Ville inconnue', '44000'),
  (16, '54 Boulevard Haussmann', 'Ville inconnue', '21000'),
  (17, '146 Boulevard Victor Hugo', 'Ville inconnue', '51100'),
  (18, '81 Rue Lafayette', 'Ville inconnue', '13000'),
  (19, '86 Avenue Jean Jaures', 'Ville inconnue', '75000'),
  (20, '147 Boulevard du Marechal Foch', 'Ville inconnue', '31000'),
  (21, '88 Avenue de Bretagne', 'Ville inconnue', '37000'),
  (22, '81 Rue du Temple', 'Ville inconnue', '21000'),
  (23, '87 Rue des ecoles', 'Ville inconnue', '30000'),
  (24, '147 Rue du Port', 'Ville inconnue', '30000'),
  (25, '126 Rue de Rivoli', 'Ville inconnue', '30000'),
  (26, '57 Rue Gambetta', 'Ville inconnue', '76600'),
  (27, '54 Allee des Roses', 'Ville inconnue', '76600'),
  (28, '17 Avenue Montaigne', 'Ville inconnue', '76600'),
  (29, '73 Avenue Foch', 'Ville inconnue', '38000'),
  (30, '80 Avenue du Parc', 'Ville inconnue', '63000'),
  (31, '63 Rue Moliere', 'Ville inconnue', '34000'),
  (32, '105 Rue de la Liberte', 'Ville inconnue', '51100'),
  (33, '99 Avenue des Tilleuls', 'Ville inconnue', '37000'),
  (34, '113 Rue Pasteur', 'Ville inconnue', '75000'),
  (35, '12 Chemin des Vignes', 'Ville inconnue', '35000'),
  (36, '29 Rue de la Fontaine', 'Ville inconnue', '76600'),
  (37, '35 Rue du General de Gaulle', 'Ville inconnue', '38000'),
  (38, '12 Avenue de la Republique', 'Ville inconnue', '13000'),
  (39, '129 Rue emile Zola', 'Ville inconnue', '76600'),
  (40, '110 Boulevard des Capucines', 'Ville inconnue', '51100'),
  (41, '122 Avenue des Fleurs', 'Ville inconnue', '59000'),
  (42, '7 Chemin de la Croix', 'Ville inconnue', '37000'),
  (43, '7 Rue Nationale', 'Ville inconnue', '69000'),
  (44, '137 Avenue de la Gare', 'Ville inconnue', '63000'),
  (45, '98 Avenue du President Wilson', 'Ville inconnue', '21000'),
  (46, '1 Rue Saint-Nicolas', 'Ville inconnue', '34000'),
  (47, '139 Boulevard de Strasbourg', 'Ville inconnue', '44000'),
  (48, '146 Rue du Chateau', 'Ville inconnue', '69000'),
  (49, '76 Rue du Moulin', 'Ville inconnue', '76600'),
  (50, '27 Rue des Martyrs', 'Ville inconnue', '06000');
...
INSERT INTO offre (id_offre, titre, description, gratification, date_offre, duree, id_entreprise) VALUES
  (1, 'Stage Developpeur Web', 'Offre de stage dans le domaine Web. Rejoignez une equipe dynamique.', 630.5, '2024-10-20', '5 mois', 10),
  (2, 'Stage Data Analyst', 'Offre de stage dans le domaine Analyst. Rejoignez une equipe dynamique.', 720, '2024-02-01', '6 mois', 8),
  (3, 'Stage Marketing', 'Offre de stage dans le domaine Marketing. Rejoignez une equipe dynamique.', NULL, '2025-04-09', '1 mois', 10),
  (4, 'Stage DevOps', 'Offre de stage dans le domaine DevOps. Rejoignez une equipe dynamique.', 750, '2024-02-17', '4 mois', 25),
  (5, 'Stage UX Designer', 'Offre de stage dans le domaine Designer. Rejoignez une equipe dynamique.', 610, '2023-07-13', '2 mois', 12),
  (6, 'Stage Comptabilite', 'Offre de stage dans le domaine Comptabilite. Rejoignez une equipe dynamique.', 590, '2025-06-12', '4 mois', 17),
  (7, 'Stage Cybersecurite', 'Offre de stage dans le domaine Cybersecurite. Rejoignez une equipe dynamique.', 760, '2024-06-23', '2 mois', 6),
  (8, 'Stage Chef de projet', 'Offre de stage dans le domaine projet. Rejoignez une equipe dynamique.', 680, '2025-12-30', '4 mois', 3),
  (9, 'Stage RH', 'Offre de stage dans le domaine RH. Rejoignez une equipe dynamique.', 577.5, '2025-10-09', '4 mois', 4),
  (10, 'Stage Commercial', 'Offre de stage dans le domaine Commercial. Rejoignez une equipe dynamique.', 600, '2025-05-24', '5 mois', 25),
  (11, 'Alternance Developpeur', 'Offre de stage dans le domaine Developpeur. Rejoignez une equipe dynamique.', 800, '2023-01-03', '6 mois', 15),
  (12, 'Stage IA/ML', 'Offre de stage dans le domaine IA/ML. Rejoignez une equipe dynamique.', 770, '2023-08-31', '2 mois', 16),
  (13, 'Stage Reseau', 'Offre de stage dans le domaine Reseau. Rejoignez une equipe dynamique.', 100, '2025-10-26', '1 mois', 6),
  (14, 'Stage Communication', 'Offre de stage dans le domaine Communication. Rejoignez une equipe dynamique.', 580, '2024-05-09', '2 mois', 7),
  (15, 'Stage Finance', 'Offre de stage dans le domaine Finance. Rejoignez une equipe dynamique.', 150, '2025-09-07', '1 mois', 12),
  (16, 'Stage Logistique', 'Offre de stage dans le domaine Logistique. Rejoignez une equipe dynamique.', 620, '2025-04-01', '5 mois', 3),
  (17, 'Stage Developpeur Mobile', 'Offre de stage dans le domaine Mobile. Rejoignez une equipe dynamique.', 740, '2025-01-09', '6 mois', 22),
  (18, 'Stage Product Manager', 'Offre de stage dans le domaine Manager. Rejoignez une equipe dynamique.', 660, '2023-03-06', '5 mois', 16),
  (19, 'Stage Support IT', 'Offre de stage dans le domaine IT. Rejoignez une equipe dynamique.', 400, '2024-05-31', '2 mois', 10),
  (20, 'Stage Juridique', 'Offre de stage dans le domaine Juridique. Rejoignez une equipe dynamique.', 577.5, '2023-01-06', '5 mois', 18),
  (21, 'Stage Developpeur Backend', 'Offre de stage dans le domaine Backend. Rejoignez une equipe dynamique.', 750, '2025-01-17', '6 mois', 7),
  (22, 'Stage Community Manager', 'Offre de stage dans le domaine Manager. Rejoignez une equipe dynamique.', 577.5, '2024-07-29', '3 mois', 2),
  (23, 'Stage Ingenieur Donnees', 'Offre de stage dans le domaine Donnees. Rejoignez une equipe dynamique.', 730, '2024-05-30', '3 mois', 6),
  (24, 'Stage Responsable Qualite', 'Offre de stage dans le domaine Qualite. Rejoignez une equipe dynamique.', 610, '2023-02-25', '2 mois', 17),
  (25, 'Stage Business Analyst', 'Offre de stage dans le domaine Analyst. Rejoignez une equipe dynamique.', 695, '2023-08-24', '2 mois', 11),
  (26, 'Stage Infographiste', 'Offre de stage dans le domaine Infographiste. Rejoignez une equipe dynamique.', 590, '2023-11-20', '5 mois', 20),
  (27, 'Stage Developpeur Frontend', 'Offre de stage dans le domaine Frontend. Rejoignez une equipe dynamique.', 735, '2025-10-06', '4 mois', 25),
  (28, 'Stage Administrateur Systeme', 'Offre de stage dans le domaine Systeme. Rejoignez une equipe dynamique.', 715, '2024-01-02', '3 mois', 21),
  (29, 'Stage Achat', 'Offre de stage dans le domaine Achat. Rejoignez une equipe dynamique.', 580, '2023-07-14', '6 mois', 15),
  (30, 'Stage Audit', 'Offre de stage dans le domaine Audit. Rejoignez une equipe dynamique.', 650, '2023-06-02', '3 mois', 18);
